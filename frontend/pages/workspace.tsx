  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const agentMsg: Message = {
        ...
        content: `Hello! I'm ${targetAgent?.name}, your ${targetAgent?.role.replace('_', ' ')}. I've analyzed your request and I'm ready to help. Let me break this down for you...`,
        timestamp: new Date().toISOString(),
        artifact: {
          type: 'code',
          title: 'Sample Implementation',
          content: `// Generated by ${targetAgent?.name}\nfunction exampleCode() {\n  console.log("This is a sample artifact");\n  return "Success";\n}`,
          language: 'javascript'
        }
      };
